...
DirectoryFilterPanelQuestion.fragment = gql`
  ...
  ${DirectoryFilterPanelQuestionHeader.fragment}
  ${DirectoryFilterPanelQuestionOptionList.fragment}
  ${DirectoryFilterPanelQuestionSelectedOptionList.fragment}
`;
